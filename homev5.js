...
function loadGoogleMapsAPI() {
  ...
  if (!mapLoaded) {
    ...
    script.src =
      "https://maps.googleapis.com/maps/api/js?key=AIzaSyBvoUcGtPBjUewpNhFXpf_r6rue6cyVvnY&callback=initMap&libraries=places&region=de&region=us&v=weekly";
    script.defer = true;
    ...
    // Update the flag to indicate that the Google Maps script is loaded
    mapLoaded = true;
  }
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const loadMapButton = document.getElementById("hero-wrap");
  loadMapButton.addEventListener("mouseover", loadGoogleMapsAPI);
